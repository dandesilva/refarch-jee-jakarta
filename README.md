...
This project is a **migrated and modernized version** of [IBM's reference architecture for JEE Customer Order Services]([https://github.com/ibm-cloud-architecture/refarch-jee-customerorder](https://github.com/ibm-cloud-architecture/refarch-jee)).
