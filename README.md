...
This project is a **migrated and modernized version** of IBM's reference architecture for JEE Customer Order Services. The application has been upgraded from legacy JavaEE 5/6 to **Jakarta EE 10**, enabling it to run on modern application servers and cloud-native infrastructure.
