...
|-----------|-----------|---------|
| **Language** | Java | **11 (LTS)** - _This branch_ |
...
> **📌 Note:** This is the **Java 11 branch**. For Java 21 version (recommended), see the [`java-21` branch](../../tree/java-21). For version comparison, see [VERSION_MATRIX.md](VERSION_MATRIX.md).
